\section{Virtual try-on} \label{section:vton}
	...
	\subsection{Augmented reality try-on}
		...
		\lithead[]{di2020comparative}{
			Proposes the use of four neural models: Fully Connected Neural Network, CNN, MobileNetV1, and MobileNetV2, to classify clothing images for computationally limited platforms on which augmented reality is often implemented. Using MobileNetV2 improves the accuracy to 92.91\% but increases training time significantly.
		}
