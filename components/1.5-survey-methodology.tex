\section{\textbf{Survey Methodology and Results}} \label{section:survey-methodology}
	...
	\begin{figure}
		...
		\begin{tikzpicture}[
			...
			\node (n2) [rNode, join] {222 additional documents identified  through other sources};
			\node (n3) [rNode, join] {1077 full-text articles assessed for eligibility};
			\node (n4) [rNode, join] {150 documents included in survey};
			\node (n1r) [rNode, right=of n1] {74 duplicates excluded};
			\node (n2r) [rNode, right=of n2] {28 duplicates excluded};
